            ...
            <f7-view id="right-panel-view" navbar-through :dynamic-navbar="true">
                ...
                <f7-pages>
                    <f7-page>
                        ...
                        <f7-block-title>Load page in main view</f7-block-title>
                        <f7-list>
                            <f7-list-item link="/about/" title="About test" link-view="#main-view"
                                          link-close-panel></f7-list-item>
                            <f7-list-item link="/form/" title="Form" link-view="#main-view"
                                          link-close-panel></f7-list-item>
                        </f7-list>
            ...
            <f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
                ...
                <f7-pages>
                    <f7-page>
                        ...
                        <f7-list>
                            <f7-list-item link="/about/" title="sdf 1"></f7-list-item>
                            <f7-list-item link="/form/" title="Form"></f7-list-item>
                            <f7-list-item link="/dynamic-route/blog/45/post/125/?foo=bar#about"
                                          title="Dynamic Route"></f7-list-item>
                            <f7-list-item link="/accordion">go Accordion</f7-list-item>
                            <f7-list-item link="/param/pid123/child/cid45#open?pageId=3">go param 测试 页面
                            </f7-list-item>
